...
public class TeamRepository {
    ...
    public static void insertTeamsStats(int matchId, Team teamOne, Team teamTwo) throws SQLException, ClassNotFoundException{
    ...
    private static void insertTeamStat(int matchId, Team teamOne, Team teamTwo) throws SQLException, ClassNotFoundException {
        connection = Connection.getConnection();
    ...
    public static void insertPlayerStats(int matchId, int teamId,  ArrayList<Player> players) throws SQLException, ClassNotFoundException {
        connection = Connection.getConnection();
        connection.setAutoCommit(false);
        try {
    ...
    public static ArrayList<String> getTeamScore(int matchId, int teamId) throws SQLException, ClassNotFoundException {
        ArrayList<String> teamScore=new ArrayList<>();
        ...
        teamScore.add("Runs Scored : "+teamStats.getInt("Runs"));
        teamScore.add("Wickets Taken  : "+teamStats.getInt("WicketsTaken"));
        return teamScore;
    }
